...
src_button_grab = Button(frmMain, 
						text = "Snip Source Image", 
						command = snipsrc) 
match_button_grab = Button(frmMain, 
						text = "Snip Tobe Match Image", 
						command = snipmatch) 
...
src_button_grab.grid(column = 1, row = 1) 
match_button_grab.grid(column = 2, row = 1)
src_img_label.grid(row = 2,column = 1,padx=10, pady=10)
match_img_label.grid(row = 2,column = 2,padx=10, pady=10)
lmain_src.grid(row = 3,column = 1,padx=10, pady=10)
lmain_match.grid(row = 3,column = 2,padx=10, pady=10)
